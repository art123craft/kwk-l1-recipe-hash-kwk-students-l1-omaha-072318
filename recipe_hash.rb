...
perfect_10_recipe = {"almond flour" => 2 cups, "gluten freewhole oats" => 1 cups, "kosher salt" => 1/2 teaspoon, "baking powder" => 1/2 teaspoon, "Xanthan gum" => 1/2 teaspoon, "slivered almonds,lightly toasted" => 1/4 cup, "mini dark chocolate chips" => 3/4 cup, "olive oil" => 1/2 cup, "agave" => 1/4 cup
